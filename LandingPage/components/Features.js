...
const Features = () => {
  ...
  const handleRedirect = (role) => {
    window.open(`http://localhost:3000/auth?role=${role}`, "_self");
  };
    ...
    <div className="container mx-auto px-3 md:px-10">
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <div onClick={() => handleRedirect('player')} className="cursor-pointer w-full h-full">
            <BentoCard
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <div onClick={() => handleRedirect('organiser')} className="cursor-pointer w-full h-full">
            <BentoCard
              ...
              description="Empowering gamers, teams, and admins to unite, compete, and thrive in a seamless esports arena experience."
            />
          </div>
        </BentoTilt>

        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <div onClick={() => handleRedirect('admin')} className="cursor-pointer w-full h-full">
            <BentoCard
